...
This app predicts whether the student will be placed  or not based on the some factors in the dataset. 
...
st.write('Student will be Placed' if predicted_value ==1 else 'Student Not placed')
